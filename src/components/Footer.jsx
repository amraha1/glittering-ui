...
const Footer = () => {
  return (
    <footer className="bg-beige/30 py-16">
      <div className="max-w-6xl mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-textDark/70">info@address.com</p>
              </div>
              <div>
                <h4 className="font-medium mb-2">Headquarters</h4>
                <p className="text-textDark/70">9235 Bayberry Drive</p>
                <p className="text-textDark/70">Hendersonville, NC 28792</p>
              </div>
            </div>
          </div>
          ...
          {/* Shop Links */}
          <div>
            <h4 className="font-medium text-xl mb-6">Shop</h4>
            <ul className="space-y-4 text-textDark/70">
              <li>Gift Cards</li>
              <li>Secure Payment Information</li>
              <li>Gift Wrapping & Packaging</li>
              <li>Returns</li>
          ...
          {/* Useful Links */}
          <div>
            <h4 className="font-medium text-xl mb-6">Useful</h4>
            <ul className="space-y-4 text-textDark/70">
              <li>Certificates</li>
              <li>Platform</li>
              <li>FAQ's</li>
        ...
        {/* Bottom Section */}
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-textDark/10 mt-16 pt-8">
          <p className="text-textDark/60 text-sm mb-4 md:mb-0">
            © 2020 Energetic Themes • All Rights Reserved
          </p>
          <div className="flex gap-6">
            <a href="#" className="text-textDark/60 hover:text-textDark">
